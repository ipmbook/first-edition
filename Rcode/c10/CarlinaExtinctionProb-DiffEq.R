...
#  NOTE: we do this without passing to the diffusion approximation in 
...
legend("topright",legend=c("IBM simulations","Difference Eqn Approx","Diffusion Approx 3","Diffusion Approx 2"),
    lty=c(1,2,2,2),lwd=c(2,1,1,1),pch=c(17,16,1,2),bty="n",cex=1.05); 

dev.copy2eps(file="../../c10/figures/CarlinaDiffEq.eps")
