## Parameters and functions for the Carlina density independent IPM 
...
##Note there is a p.r in F as we're building a density independent IPM
...
F_z1z <- function (z1, z, m.par) {
    ...
    return( s_z(z, m.par) * p_bz(z, m.par) * b_z(z, m.par)  * m.par["p.r"]  * c_0z1(z1, m.par))
