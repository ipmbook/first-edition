## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
## Use the Monocarp IBM to illustrate bootstrap uncertainty analysis for an IPM
##
## We assume the simplest situation, an unstructured bootstrap corresponding to data
## where new individuals are marked at random each year, and their fate the following year
## is observed, but individuals are not followed for life. We therefore construct bootstrap 
## samples by resampling totally at random (with replacement) from the data. 
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
## Part 1: the unknowable "TRUTH": How much does estimated lamba  
## vary across many replicate data sets? 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
No.sims <-250; 
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Part 2: What you can do with one real data set, is bootstrap by resampling
# from the data in hand. 
# We do this 5 times to see that the results are consistent 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
plot(out$x,out$y,type="l",lwd=2,xlab="Estimated lambda",ylab="Frequency",ylim=c(0,9.5))
