...
init.pop.size <- 1000; n.yrs <-50; 
source("Monocarp Simulate IBM.R") 

## Use 49th year and select 1000 observations
## to be our dataset 
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Function to compute lambda from a bootstrapped data set
# in the format that the boot library requires. 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# Do the bootstrap 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
boot.out = boot(data=sim.data, statistic=boot.lam, simple=TRUE, R=999);
...
bcpi = function(t0,t,alpha) {
    ...
    c1=quantile(t,a1); c2=quantile(t,a2); 
