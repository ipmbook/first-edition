...
for(gen in 1:n.iter){
	...
	beta.t[gen] <- params["flow.int"] + d.lambda.d.beta * var.flow.int.minus20[gen]
	
	params["flow.int"] <- beta.t[gen]
...
points(t.plot,beta.t[t.plot],type="l",col="blue")
abline(h=ESS.fl.int,col="red") #adding ESS from calculation below


plot(t.plot,var.flow.int.minus20[t.plot],type="l",)
