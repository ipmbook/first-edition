...
save(mean.flow.ints,var.flow.ints,min.z,max.z,min.beta,max.beta,n.yrs,beta.off.sd,init.beta.sd,file="SimDataSmallVar.Rdata")
}
...
#####################################################################################
# FORTH PLOT: NEW VARIANCE APPROX
#####################################################################################
...
matplot(var.flow.ints,type="l",col=rep(c("black","grey"),rep(5,2)),xlab="Time",
	ylab="Variance beta",xlim=c(1,n.yrs),ylim=c(0,5))
